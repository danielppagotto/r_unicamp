...
GEM_APS <- read_excel("~/GitHub/r_unicamp/02_dados/GEM_APS.xlsx",
...
| OBS.: O objeto `|>` se chama pipe. Ele é um elemento muito comum na estrutura do tidyverse. O que ele significa? Ele é artifício para encadear funções no R. Com o passar do seu uso ficará mais claro. O **atalho** para o pipe é **Ctrl + Shift + M**.
